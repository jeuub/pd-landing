      ...
      <section className={'section team'} id={'team'}>
        <div className={'team__inner'}>
          ...
          <div className={'team_devs devs'}>
            <Dev className={'devs_dev'} name={'Эййюб Бодур'} img={bebup} resp={'Full-stack разработчик'} text={'Группа: 201-321'}>
              <div className={'devs__links'}>
                <SocialLink image={GithubIcon} link={'https://github.com/jeuub'} alt={'jeuub github'}/>
                <SocialLink image={TelegramIcon} link={'https://t.me/meowken'} alt={'jeuub telegram'}/>
              </div>
            </Dev>
            <Dev className={'devs_dev'} name={'Матвей Бухарцев'} img={matvey} resp={'Front-end разработчик'} text={'Группа: 201-321'}>
              <div className={'devs__links'}>
                <SocialLink image={GithubIcon} link={'https://github.com/bouhartsev'} alt={'bouhartsev github'}/>
                <SocialLink image={TelegramIcon} link={'https://t.me/bouhartsev'} alt={'bouhartsev telegram'}/>
              </div>
            </Dev>
          </div>
        </div>
      ...
      <section className={'section stack'} id={'stack'}>
        <div className={'stack__inner'}>
          ...
          <Message
            ...
            self
          >
            Так, ну на фронте у нас <strong>React</strong> в связке с <strong>Typescript</strong> и <strong>Apollo client</strong>.<br/>
            Типизациця поможет нам делать меньше ошибок, а Apollo client вместе с <strong>Apollo server</strong>  обеспечит легкое взаимодействие с <strong>GraphQL</strong> на сервере.
            <br/>
            На беке у нас будет <strong>Nodejs</strong> + <strong>Express</strong>, а как СУБД я выбрал <strong>MongoDB</strong>. <wbr/>
            А еще инструменты <strong>Figma</strong>, <strong>Docker</strong>
          </Message>
          <Message
            className={'project__message project__message--important'}
            name={'🤴🏻Матвей'}
          ...
          >
            ...
            back: Nodejs + Express + MongoDB + Apollo Server <br/><br/>
          </Message>
          <Message
            className={'project__message'}
            name={'🤴🏻Матвей'}
